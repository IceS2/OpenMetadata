...
from metadata.ingestion.models.topology.queue import Queue
from metadata.ingestion.models.topology.context_manager import TopologyContextManager
from metadata.ingestion.models.topology.service import get_topology_node, get_topology_root
...
from metadata.ingestion.api.steps import SourceStep
...
class TopologyRunner(SourceStep):
    """
    Prepares the _run function
    dynamically based on the source topology
    """

    def __init__(self, source: Source, context: TopologyContextManager, metadata: OpenMetadata):
        self.source = source
